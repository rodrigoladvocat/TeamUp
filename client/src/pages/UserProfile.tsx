...
const UserProfile = () => {
  ...
  return (
    <div className="flex flex-row w-[1440px] h-screen justify-center max-h-screen p-6 bg-general-background text-white">
      <aside>
        <Menu></Menu>
      </aside>
      ...
      <main className="flex flex-col p-6 bg-general-background h-[920px] w-full">
        ...
        <div className="flex flex-col bg-content-background h-full mt-8">
          <div className="flex flex-row justify-evenly gap-x-[52px] py-10">
            ...
            <div className="w-[384px]">
              <div>
                ...
                <div className="text-left text-16 h-[127px]">{user.bio}</div>
              </div>
              <div>
