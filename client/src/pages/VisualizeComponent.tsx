...
import FinalEvaluationManagerPage from "./manager/FinalEvaluation/FinalEvaluationManager";
import OthersEvaluationTab from "./manager/FinalEvaluation/OthersEvaluationTab";
...
export default function VisualizeComponent({}: Props): JSX.Element {
  return (
    <div className="snap-center self-center items-center origin-center place-self-center justify-self-center">
      ...
      <OthersEvaluationTab></OthersEvaluationTab>
      ...
      <div className="flex flex-col space-y-8">
        ...
        <div className="flex flex-row space-x-20">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <TipSpeechBubble
              text={
                "A sua nota final da avaliação referente ao ciclo de avaliação 2021.1 já está no portal e você pode encontrá-la na página “Notas”."
              }
            ></TipSpeechBubble>
            <TipSpeechBubble
              triangleSide={"down"}
              text={
                "O ciclo avaliativo terminou, vá até a aba de avaliações para avaliar os colaboradores."
              }
            ></TipSpeechBubble>
            <TipSpeechBubble
              triangleSide={"up"}
              text={
                "lorem ipsum looooong text lorem ipsum looooong text lorem ipsum looooong text lorem ipsum looooong text lorem ipsum looooong text "
              }
            ></TipSpeechBubble>
          </div>
        </div>
