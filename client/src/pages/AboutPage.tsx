          ...
          <div className="flex-1 bg-content-background h-[780px] max-w-[64.25rem] mt-6">
            <div className="flex-1 bg-content-background p-8 pt-4 pb-2 ">
              ...
              <div className="text-left font-poppins text-base">
                ...
                ferramenta eficaz para o gerenciamento e a gestão da performance
                dos colaboradores de uma empresa. Através dela, é possível
                registrar o desempenho individual e compartilhar a visão que um
                colaborador tem sobre o outro, permitindo que todos conheçam
                seus pontos fortes e identifiquem áreas de melhoria. Tudo isso é
                feito de maneira confidencial e discreta, garantindo a
                privacidade dos colaboradores.Com uma gestão aprimorada do
                desempenho, as empresas podem desenvolver estratégias para
                maximizar o potencial de cada colaborador, fortalecendo sua
                posição no mercado e impulsionando o sucesso organizacional.
              </div>
            </div>
                ...
                <div className="p-4 text-center h-[12.5rem]">
                  {!user?.isManager ? (
                    ...
                    <>
                      ...
                      <p className="pt-6 font-poppins">
                        Acompanhe o andamento do ciclo avaliativo e tenha acesso
                        as notas e feedbacks de cada colaborador.
                      </p>
                    </>
                  )}
                </div>
                ...
                <div className="flex justify-between items-start">
                  <div className="w-1/2 text-right pr-11 flex flex-col items-end">
                    ...
                    <p className="text-16 w-[373px]">
                      ...
                      avaliações é realizado um processo de equalização que gera
                      uma nota final condizente com toda a informação obtida a
                      respeito de cada colaborador.
                    </p>
                  </div>
                  <div className="w-1/2 flex items-start">
                    <div className="bg-primary h-[48px] w-[48px] rounded-full transform -translate-x-1/2 flex items-center justify-center">
